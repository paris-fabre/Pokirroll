...
export const INITIAL_INGREDIENTS: Ingredient[] = [
  // --- BASES ---
  { id: 'b_arroz_sushi', name: 'Arroz de sushi', category: 'base', colors: ['#ffffff', '#f4f4f5'], icon: '🍚', imageUrl: 'https://images.unsplash.com/photo-1536304997881-a372c179924b?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'b_arroz_yamani', name: 'Arroz yamani', category: 'base', colors: ['#c4a482', '#9f815b'], icon: '🌾', imageUrl: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'b_mix_verdes', name: 'Mix de verdes', category: 'base', colors: ['#22c55e', '#15803d'], icon: '🥬', imageUrl: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  { id: 'p_salmon_cocido', name: 'Salmón cocido', category: 'protein', colors: ['#fbcfe8', '#f472b6'], icon: '🐟', imageUrl: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  { id: 'p_pollo', name: 'Pollo', category: 'protein', colors: ['#fcd34d', '#d97706'], icon: '🍗', imageUrl: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'p_tofu', name: 'Tofu', category: 'protein', colors: ['#f1f5f9', '#cbd5e1'], icon: '⬜', imageUrl: 'https://images.unsplash.com/photo-1584270258169-231a4c9b9328?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  // --- VEGETABLES ---
  { id: 'v_pepino', name: 'Pepino', category: 'vegetable', colors: ['#86efac', '#22c55e'], icon: '🥒', imageUrl: 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'v_cebolla_morada', name: 'Cebolla morada', category: 'vegetable', colors: ['#d946ef', '#a21caf'], icon: '🧅', imageUrl: 'https://images.unsplash.com/photo-1618220179428-22790b461013?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'v_zanahoria', name: 'Zanahoria', category: 'vegetable', colors: ['#fb923c', '#ea580c'], icon: '🥕', imageUrl: 'https://images.unsplash.com/photo-1598170845058-32b996a6bd11?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  { id: 'e_alga_nori', name: 'Alga nori', category: 'extra', colors: ['#1e293b', '#0f172a'], icon: '⬛', imageUrl: 'https://images.unsplash.com/photo-1534482421-64566f976cfa?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  { id: 'e_jengibre', name: 'Jengibre', category: 'extra', colors: ['#fbcfe8', '#fda4af'], icon: '🍥', imageUrl: 'https://images.unsplash.com/photo-1596097421404-98cb300212e5?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  { id: 'e_philadelphia', name: 'Philadelphia', category: 'extra', colors: ['#f8fafc', '#ffffff'], icon: '🧀', imageUrl: 'https://images.unsplash.com/photo-1528750994873-112402c020a3?auto=format&fit=crop&w=250&h=250&q=80', available: true },
  ...
  { id: 's_ponzu', name: 'Ponzu', category: 'sauce', colors: ['#451a03', '#1c0a00'], icon: '🥃', imageUrl: 'https://images.unsplash.com/photo-1591123720235-efde9e14fc75?auto=format&fit=crop&w=250&h=250&q=80', available: true },
